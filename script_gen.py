...
# Improved heuristic script generator that expands on the idea with a clear structure
...
def split_script_into_scenes(script: str, target_total: float = 45.0) -> List[Scene]:
    ...
    # Allocate time proportionally by words; default target ~45s
...
def generate_script_and_scenes(idea: str) -> ScriptResult:
    # If OPENAI_API_KEY present and openai package available, attempt LLM generation; else rich heuristic.
    script = None
